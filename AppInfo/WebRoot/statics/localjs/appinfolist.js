...
$(".addVersion").on("click", function() {
	var obj = $(this);
	window.location.href = "appversionadd?appId=" + obj.attr("appinfoid");
});
...
var saleSwitchAjax = function(appId, obj) {
	var type = obj.attr("saleSwitch");
	$.post("sale?id=" + appId + "&type=" + type, function(data) {
		if (type == "open" && data == "opentrue") {
		...
		} else if (type == "close" && data == "closetrue") {
...
$(".viewApp").on("click", function() {
	var obj = $(this);
	window.location.href = "developer/appview?id=" + obj.attr("appinfoid") + "&devId=" + obj.attr("devId");
});
