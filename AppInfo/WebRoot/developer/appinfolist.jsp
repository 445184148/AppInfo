...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="selectAppInfoList">
					<input type="hidden" name="devId" value="${devUserSession.id }">
				...
				<div class="row">
					...
					<a href="${pageContext.request.contextPath}/developer/appinfoadd.jsp" class="btn btn-success btn-sm">新增APP基础信息</a>
                      ...
                      <ul class="dropdown-menu" role="menu">
                        ...
                        <li><a  class="viewApp"  href="appview?id=${appInfo.id}&devId=${devUserSession.id}" appinfoid=${appInfo.id } devId=${devUserSession.id} data-toggle="tooltip" data-placement="top" title="" data-original-title="查看APP基础信息以及全部版本信息">查看</a></li>
							...
							<ul class="pagination">
								...
								<c:if test="${pageIndex < pageNo }">
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${pageNo });"
