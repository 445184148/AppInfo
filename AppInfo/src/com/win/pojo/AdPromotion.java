...
public class AdPromotion {
	...
	public AdPromotion(Integer id, Integer appId, String adPicPath,
			Integer adPV, Integer carouselPosition, Date startTime,
			Date endTime, Integer createdBy, Date creationDate,
